...
[![Validate](https://github.com/markwpearce/brighterscript-game-engine/actions/workflows/validate.yml/badge.svg)](https://github.com/markwpearce/brighterscript-game-engine/actions/workflows/validate.yml) [![Unit Tests](https://github.com/markwpearce/brighterscript-game-engine/actions/workflows/unit-tests.yml/badge.svg)](https://github.com/markwpearce/brighterscript-game-engine/actions/workflows/unit-tests.yml) [![Docs](https://img.shields.io/badge/docs-online-blue)](https://markwpearce.github.io/brighterscript-game-engine) [![License: MIT](https://img.shields.io/badge/license-MIT-green)](LICENSE)
...
![A red rocket ship flying through a starry blue nebula, dodging gray asteroids, with a score of 5 shown at the top](/_assets/asteroids.8236feeb.jpg)

[Asteroids example](https://github.com/markwpearce/brighterscript-game-engine/tree/main/examples/asteroids) - 2D movement, collisions, and scoring

![A rotating 3D cube textured with the Roku logo on a black background, with on-screen controls for rotation, camera movement, and draw mode](/_assets/3d.1b558571.jpg)

[3D example](https://github.com/markwpearce/brighterscript-game-engine/tree/main/examples/3d) - loading and rendering .stl 3D models with the pseudo-3D renderer

![A classic Snake game: a green snake made of square segments turning a corner toward a red apple, on a black grid with a white border](/_assets/snake.53724912.jpg)

[Snake example](https://github.com/markwpearce/brighterscript-game-engine/tree/main/examples/snake) - grid-based movement and a growing collision shape
